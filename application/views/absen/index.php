                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xxs font-weight-bold text-warning text-uppercase mb-1">
                            Pulang Awal</div>
                        <div class="h6 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_keluar_sebelum_16; ?></div>
                    </div>
                    <div class="col-auto">
...
<div class="col-md-6 mb-4">
    <?php if ($absen && $absen['jam_masuk']): ?>
        ...
        <a href="#" class="btn btn-lg btn-primary btn-block" id="absenMasuk" style="border-radius: 10px; cursor: not-allowed;" disabled>
            <i class="fas fa-camera fa-fw"></i> Absen Masuk <br>
            <?= $absen['jam_masuk']; ?>
        </a>
    <?php else: ?>
        <!-- Jika belum absen, tampilkan tombol absen dan timer -->
        <a href="<?= base_url('absen/absen_masuk') ?>" class="btn btn-lg btn-primary btn-block" id="absenMasuk"  style="border-radius: 10px; cursor: pointer;">
            <i class="fas fa-camera fa-fw"></i> Absen Masuk <br>
...
<div class="col-md-6 mb-4">
        <?php if ($absen && !empty($absen['jam_masuk'])): ?>
            ...
            <?php if (isset($absen['jam_keluar']) && $absen['jam_keluar'] !== "00:00:00"): ?>
                ...
                <a href="#" class="btn btn-lg btn-danger btn-block" id="absenKeluar" style="border-radius: 10px; cursor: not-allowed;" disabled>
                    <i class="fas fa-camera fa-fw"></i> Absen Keluar <br>
                    <?= $absen['jam_keluar']; ?>
                </a>
            <?php else: ?>
                <!-- Jika belum absen keluar, tampilkan tombol absen keluar -->
                <a href="<?= base_url('absen/absen_keluar') ?>" class="btn btn-lg btn-danger btn-block" id="absenKeluar" style="border-radius: 10px; cursor: pointer;">
                    <i class="fas fa-camera fa-fw"></i> Absen Keluar <br>
