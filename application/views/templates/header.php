...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <style>
		 .notification {
            ...
            bottom: 50px;
            right: 50px;
            background-color: #28a745; /* Warna success */
            color: #fff;
            padding: 20px;
            border-radius: 10px;
            display: none;
		...
		.disabled-row {
			background-color: #adadad; /* Warna abu-abu gelap */
    pointer-events: none;      /* Menonaktifkan interaksi pengguna */
    opacity: 0.7;              /* Membuat baris terlihat lebih redup */
    color: #6c757d;            /* Membuat baris terlihat kurang menonjol */
}
@media print {
        body * {
            visibility: hidden;
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Add the logo image here -->
			<img src="<?= base_url('assets/foto/logo.jpeg'); ?>" alt="Logo" style="height: 40px; margin-right: 10px;">
				</div>
...
<ul class="navbar-nav ml-auto">
	...
	<a class="nav-link dropdown-toggle" style="color: black;" href="#" id="alertsDropdown" role="button" 
    aria-haspopup="true" aria-expanded="false">
    
    Hi, <?= $this->session->userdata('name') ?>&nbsp;&nbsp;

	<i class="fas fa-user" style="margin-right : 8px"></i> <!-- Ikon orang dari Font Awesome -->
</a>
        <!-- Dropdown - Alerts -->
