					...
					<div class="form-group">
                        ...
                        <div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="role" id="hak_akses_admin" value="Admin" required>
                                <label class="form-check-label" for="hak_akses_admin">
                                    Admin
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="role" id="hak_akses_pbj_owner" value="Karyawan" required>
