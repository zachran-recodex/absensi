                ...
                <div>
                    ...
                    ?>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="hak_akses" id="hak_akses_<?= strtolower(str_replace(' ', '_', $akses)) ?>" value="<?= $akses ?>" <?= $checked ?> required>
                            <label class="form-check-label" for="hak_akses_<?= strtolower(str_replace(' ', '_', $akses)) ?>">
                                <?= $akses ?>
                            </label>
                        </div>
                    <?php endforeach; ?>
